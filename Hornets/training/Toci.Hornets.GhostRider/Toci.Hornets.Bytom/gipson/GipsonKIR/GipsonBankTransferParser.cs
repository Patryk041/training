...
namespace Toci.Hornets.Bytom.gipson.GipsonKIR
{
    public class GipsonBankTransferParser : BankTransfersParser
    {
        ...
        //dodac sciezke
        private const string Path = @"C:\TOCI repository\Hornets\training\Toci.Hornets.GhostRider\Toci.Hornets.Bytom\gipson\GipsonKIR\Transactions\Transactions1.txt";
        private const string Path2 = @"..\..\..\Toci.Hornets.Bytom\gipson\GipsonKIR\Transactions\Transactions1.txt";
