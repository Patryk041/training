...
namespace Toci.Hornets.UnitTests.Kalisz.Amman
{
    ...
    public class UnitTester
    {
        ...
        {
            var tekst =
                "mam pewność że tak będzie boa) będzie opowiadał o Biblii)będzie długic)będzie rozważaniem sensu w okrucieństwienawet jeśli ambicja każe ci to czytać bo sprowokowałem ją tytułem to sobie daruj, zwykle czytasz krótkie informacje a ta będzie długa, nudna i wymagająca myślenia, myślenie zaś boli wiec może porzuć dumę i sie nie przemęczaj nie dodam w tym tekscie żadnego kolorowego obrazka po to by zwrócił uwagę kogokolwiek, nie będzie krótkim fotoblogowym wpisem co to się rzuca w oczy i można zaraz o nim zapomniec a główka jak była pusta tak jest " +
